...
--
-- Host: 127.0.0.1:3306
-- Gegenereerd op: 04 mrt 2019 om 17:06
-- Serverversie: 5.7.19
-- PHP-versie: 7.0.23
...
(52, 6, 'meta_keywords', 'text', 'Meta Keywords', 0, 0, 0, 0, 0, 0, '{}', 8),
(53, 6, 'status', 'select_dropdown', 'Status', 1, 1, 1, 1, 1, 1, '{\"default\":\"INACTIVE\",\"options\":{\"INACTIVE\":\"INACTIVE\",\"ACTIVE\":\"ACTIVE\"}}', 9),
(54, 6, 'created_at', 'timestamp', 'Created At', 0, 1, 1, 0, 0, 0, '{}', 10),
(55, 6, 'updated_at', 'timestamp', 'Updated At', 0, 1, 1, 0, 0, 0, '{}', 11),
...
(6, 'pages', 'pages', 'Page', 'Pages', 'voyager-file-text', 'TCG\\Voyager\\Models\\Page', NULL, NULL, NULL, 1, 0, '{\"order_column\":null,\"order_display_column\":null,\"order_direction\":\"desc\",\"default_search_key\":null}', '2019-02-26 09:41:22', '2019-03-04 15:47:21');
...
(10, 1, 'Home', 'Alpha Zorg & Advies biedt zorg en advies in de vorm van ambulante begeleiding en woonbegeleiding aan jongeren vanaf 17 jaar, die door gedrags- en/of ontwikkelingsstoornis ondersteuning nodig hebben in hun dagelijks leven. Wij bieden begeleiding in één van onze woningen of in eigen woonomgeving. Hiernaast bieden wij ook ondersteuning aan ouders omtrent de zorg van hun kind,dit in het kader van de jeugdwet.', '<p>Bij ons staat de&nbsp;jongere centraal, want iedereen&nbsp;is uniek en verdient daarom ook een unieke aanpak.<br style=\"box-sizing: border-box;\" />Dit doen we door een begeleidingstraject te bieden waarbij de&nbsp;componenten:<br style=\"box-sizing: border-box;\" />Aandacht, Liefde, Praktiseren, Hervormen en Aansturing&nbsp;een&nbsp;basis zullen vormen.Hierover vertellen wij meer bij het kopje:Organisatie.<br style=\"box-sizing: border-box;\" />Wij stemmen af op uw wensen en de mogelijkheden die wij te bieden hebben. Ieder mens is waardevol en verdient een oprechte en eerlijke kans om te groeien en zich verder te ontplooien.&nbsp;&nbsp;</p>\r\n<p>Als professional staan wij&nbsp;voor u klaar om u te adviseren, ondersteunen en begeleiden naar een leven&nbsp;met perspectief.</p>\r\n<p><span style=\"box-sizing: border-box; font-weight: bold;\">Samen staan wij sterk. Een helpende hand richting een betere morgen!</span></p>', NULL, '/', 'test', 'test', 'ACTIVE', '2019-03-01 01:10:01', '2019-03-04 15:34:15');
...
(23, 'home.woonbegeleiding', 'Woonbegeleiding', 'Another example of a project with its respective description. These sections work well responsively as well, try this theme on a small screen!', NULL, 'text', 18, 'Home'),
(25, 'home.thuiszorg', 'Thuiszorg', 'An example of where you can put an image of a project, or anything else, along with a description.', NULL, 'text', 16, 'Home'),
(28, 'home.thuiszorg-img', 'Thuiszorg Foto', 'settings\\March2019\\5W0BHKv7HhiViP5JjF7F.jpg', NULL, 'image', 17, 'Home'),
(29, 'home.woonbegeleiding-img', 'Woonbegeleiding Foto', 'settings\\March2019\\QCvsmJ7FZA2N71jA86cl.jpg', NULL, 'image', 19, 'Home'),
(31, 'home.ambulant-img', 'Ambulant Foto', 'settings\\March2019\\gkc7uu7aYyAAsstZB3C0.jpg', NULL, 'image', 22, 'Home'),
(32, 'home.ambulant', 'Ambulant', 'An example of where you can put an image of a project, or anything else, along with a description.', NULL, 'text', 21, 'Home');
